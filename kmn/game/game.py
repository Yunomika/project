...
player_rock_image = pygame.image.load('player_rock.png')
player_scissors_image = pygame.image.load('player_scissors.png')
player_paper_image = pygame.image.load('player_paper.png')
image_names = ['win1.png', 'win2.png', 'win3.png', 'win4.png', 'win5.png']
img_names = ['lose1.png', 'lose2.png', 'lose3.png', 'lose4.png', 'lose5.png']

computer_rock_image = pygame.image.load('computer_rock.png')
computer_scissors_image = pygame.image.load('computer_scissors.png')
computer_paper_image = pygame.image.load('computer_paper.png')
...
def show_menu():
    ...
    while True:
        ...
        draw_text("Камень, Ножницы, Бумага", WIDTH // 2 - SMALL_BACKGROUND_FONT.size("Камень, Ножницы, Бумага")[0] // 2, HEIGHT // 4, SMALL_BACKGROUND_FONT, BLACK)
